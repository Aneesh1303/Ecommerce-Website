...
export const ProfileScreen = () => {
  ...
  return (
    <Row>
      <Col md={3}>
        <h2 className="font-2 mb-4">User Profile</h2>
        <Form onSubmit={submitHandler}>
          ...
          <Button type="submit" className="my-2 font-2 button">
            Update
          </Button>
      ...
      <Col md={9}>
        <h2 className="font-2">My Orders</h2>
        {isLoading ? (
          <Loader />
        ) : error ? (
          ...
          <Table striped hover responsive className="table-sm" id="table">
            <thead>
              <tr>
                <th>ID</th>
                <th>DATE</th>
                ...
                <tr key={order._id}>
                  ...
                  <td>
                    <LinkContainer to={`/order/${order._id}`}>
                      <Button className="details-button font-2">Details</Button>
                    </LinkContainer>
                  </td>
                </tr>
              ))}
